...
wb = xlrd.open_workbook(config.excel_file)
...
dashboard = meraki.DashboardAPI(api_key=config.meraki_api_key, print_console=True,output_log=True,log_path="logs")
my_orgs = dashboard.organizations.getOrganizations()
input_org_id = config.org_id
